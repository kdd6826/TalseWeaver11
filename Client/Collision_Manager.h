...
public:
	...
	static void CollisionRectCeiling(list<CGameObject*>& rDstList, list<CGameObject*>& rSrcList);
	static bool CheckRect(CGameObject* pDstObject, CGameObject& rSrCGameObjectect, float* pMoveX, float* pMoveY);
